...
你后面如果还在看设计，直接发我「楼盘+面积+喜欢风格」就行。我可以先帮你匹配几套同面积或相近风格案例，你先看方向，不用急着定。`,
    ...
    "玖玖精工 / 玖玖半包": {
      ...
      mind: "客户来玖玖精工，不是听半包介绍，而是做施工判断：先看真实工地，再看完工落地，有图纸或报价顾虑再到公司拆清楚。",
      defaultAction: "看工地 / 看完工 / 到公司",
      ...
      types: [
        { name: "有图纸型", concerns: ["落地", "报价"], worry: "图纸能不能落地", action: "看工地 / 看完工 / 到公司", judge: "用工地和完工案例验证落地能力，带图纸到公司判断施工难点、预算风险和落地路径。", material: "图纸节点 vs 现场节点 / 图纸精算案例" },
        { name: "工艺验证型", concerns: ["工艺"], worry: "施工靠不靠谱", action: "看工地 / 看完工 / 到公司", judge: "先看施工现场的工艺、管理、材料和节点，再看完工落地；复杂报价或图纸问题到公司拆清楚。", material: "大宅工地实拍 / 完工实景 / 水电防水泥木节点" },
        { name: "报价型", concerns: ["预算", "报价"], worry: "半包报价是否漏项", action: "看工地 / 看完工 / 到公司", judge: "看现场标准和完工结果，再到公司拆报价结构、项目、材料、工艺标准和漏项。", material: "报价结构说明 / 漏项风险清单" },
        { name: "大宅复杂型", concerns: ["设计", "全案", "落地"], worry: "别墅复式节点难", action: "看工地 / 看完工 / 到公司", judge: "看复杂节点和完工交付，判断团队能不能接住；再到公司拆图纸边界。", material: "别墅/复式/大平层复杂节点案例" },
        { name: "付款保障型", concerns: ["付款"], worry: "施工过程失控", action: "看工地 / 看完工 / 到公司", judge: "先看现场和完工结果，再到公司把施工流程、验收逻辑和付款方式看清楚。", material: "付款节点说明 / 验收流程图" },
      ],
      stageScripts: {
...
这个线上看资料很难判断清楚。建议按顺序来：先看真实工地，再看完工效果；如果你有图纸或报价顾虑，再到公司把施工难点和预算边界拆清楚。
...
你后面如果还在看精装房改造，直接发我楼盘、面积和现场照片。我先帮你判断哪些地方值得改，哪些不建议花冤枉钱。`,
    ...
    "宅师傅半包装修": {
      ...
      mind: "客户来宅师傅，不是听装修报价，而是先看真实工地验证施工，再到公司把付款、预算和增项规则讲清楚，最后免费量房把自己家怎么算清楚。",
      defaultAction: "看工地 / 到公司 / 免费量房",
      ...
      types: [
        { name: "预算型", concerns: ["预算", "报价"], worry: "半包到底多少钱", action: "看工地 / 到公司 / 免费量房", judge: "先看工地判断施工标准，再到公司讲清报价和付款规则，最后免费量房算清你家预算。", material: "预算拆解图 / 免费量房出图流程" },
        { name: "增项型", concerns: ["增项"], worry: "怕后期加钱", action: "看工地 / 到公司 / 免费量房", judge: "先看工地，再到公司把增项边界和付款验收讲清楚，最后用图纸和预算提前排雷。", material: "图纸预算流程 / 容易增项清单" },
        { name: "付款型", concerns: ["付款"], worry: "怕先交钱后被动", action: "看工地 / 到公司 / 免费量房", judge: "先看工地确认不是只讲低价，再到公司当面把验收节点、付款方式和保障规则讲清楚。", material: "付款节点说明 / 验收流程图" },
        { name: "工艺型", concerns: ["工艺", "落地"], worry: "便宜会不会质量差", action: "看工地 / 到公司 / 免费量房", judge: "先现场看施工和完工，再到公司确认规则，最后量房算清方案和预算。", material: "真实工地实拍 / 工艺节点图" },
        { name: "小白型", concerns: ["小白", "设计"], worry: "不知道从哪里开始", action: "看工地 / 到公司 / 免费量房", judge: "先看工地建立判断标准，再到公司理清流程，最后免费量房把户型、方案和预算理清楚。", material: "免费量房流程 / 装修步骤说明" },
      ],
      stageScripts: {
...
建议按顺序来：先看真实工地，再到公司把付款和增项规则讲清楚，最后免费量房，把平面图、施工图和预算做出来。这不是让你马上签，而是先把自己家装修算清楚。
...
你后面如果还在看装修，直接把小区、面积和预算大概范围发我。我先帮你判断是该看工地、到公司，还是免费量房。`,
      },
    },
  };
