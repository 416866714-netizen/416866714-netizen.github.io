...
function getB2BEffectiveContactLibrary(position = {}) {
  const brands = {
    '8K设计': {
      action: '到公司 / 看完工',
      mind: '来8K不是听销售介绍，而是做设计判断：到公司看方案、案例和服务边界，也可以看完工现场判断效果图能不能真实落地。',
      ...
      types: [
        ['设计信任型','设计','你们到底会不会设计','到公司 / 看完工','到公司看设计师怎么分析户型、需求和风格，必要时再看完工落地。','设计师户型分析过程 / 同风格案例菜单'],
        ['落地型','落地 / 工艺','效果图能不能做出来','到公司 / 看完工','看效果图、施工图、完工实景之间的完整链路。','效果图 vs 完工实拍 / 施工节点落地证据'],
        ['设计费型','预算 / 报价','8000元设计费值不值','到公司 / 看完工','到公司看服务边界，确认8000到底包含什么，再用完工案例判断落地价值。','8000设计服务清单 / 服务边界图'],
        ['案例匹配型','案例','有没有和我家相关案例','到公司 / 看完工','按面积、户型、风格匹配案例，并看完工案例验证落地。','同面积/同风格案例目录'],
        ['预算匹配型','预算','喜欢的效果装不装得起','到公司 / 看完工','结合户型、风格、预算和完工案例判断效果是否现实。','风格预算匹配说明 / 同预算案例']
      ]
    },
    '玖玖精工 / 玖玖半包': {
      action: '看工地 / 看完工 / 到公司',
      mind: '来玖玖精工不是听半包介绍，而是做施工判断：先看真实工地，再看完工落地，有图纸或报价顾虑再到公司拆清楚。',
      ...
      stages: {
        ...
        'D2-D3轻邀约': '你现在不用急着定，也不用急着交钱。\n\n你最该先判断的是施工靠不靠谱、完工效果稳不稳、报价有没有漏项、后期能不能把设计图落地。\n\n这个线上看资料很难判断清楚。建议按顺序来：先看真实工地，再看完工效果；如果你有图纸或报价顾虑，再到公司把施工难点和预算边界拆清楚。\n\n你看这周工作日，还是周末更方便？'
      },
      types: [
        ['有图纸型','落地 / 报价','图纸能不能落地','看工地 / 看完工 / 到公司','用工地和完工案例验证落地能力，带图纸到公司判断施工难点、预算风险和落地路径。','图纸节点 vs 现场节点 / 图纸精算案例'],
        ['工艺验证型','工艺','施工靠不靠谱','看工地 / 看完工 / 到公司','先看施工现场的工艺、管理、材料和节点，再看完工落地；复杂报价或图纸问题到公司拆清楚。','大宅工地实拍 / 完工实景 / 水电防水泥木节点'],
        ['报价型','预算 / 报价','半包报价是否漏项','看工地 / 看完工 / 到公司','看现场标准和完工结果，再到公司拆报价结构、项目、材料、工艺标准和漏项。','报价结构说明 / 漏项风险清单'],
        ['大宅复杂型','设计 / 全案 / 落地','别墅复式节点难','看工地 / 看完工 / 到公司','看复杂节点和完工交付，判断团队能不能接住；再到公司拆图纸边界。','别墅/复式/大平层复杂节点案例'],
        ['付款保障型','付款','施工过程失控','看工地 / 看完工 / 到公司','先看现场和完工结果，再到公司把施工流程、验收逻辑和付款方式看清楚。','付款节点说明 / 验收流程图']
      ]
    },
    '玖玖精装': {
      action: '到公司',
    ...
    '宅师傅半包装修': {
      action: '看工地 / 到公司 / 免费量房',
      mind: '来宅师傅不是听装修报价，而是先看真实工地验证施工，再到公司把付款、预算和增项规则讲清楚，最后免费量房把自己家怎么算清楚。',
      ...
      stages: {
        ...
        'D2-D3轻邀约': '你现在不用急着定，也不用急着交钱。\n\n你这个情况，最该先判断的是施工靠不靠谱、付款和增项规则清不清楚、你家半包大概要多少钱。\n\n建议按顺序来：先看真实工地，再到公司把付款和增项规则讲清楚，最后免费量房，把平面图、施工图和预算做出来。这不是让你马上签，而是先把自己家装修算清楚。\n\n你看这周工作日晚上，还是周末更方便？'
      },
      types: [
        ['预算型','预算 / 报价','半包到底多少钱','看工地 / 到公司 / 免费量房','先看工地判断施工标准，再到公司讲清报价和付款规则，最后免费量房算清你家预算。','预算拆解图 / 免费量房出图流程'],
        ['增项型','增项','怕后期加钱','看工地 / 到公司 / 免费量房','先看工地，再到公司把增项边界和付款验收讲清楚，最后用图纸和预算提前排雷。','图纸预算流程 / 容易增项清单'],
        ['付款型','付款','怕先交钱后被动','看工地 / 到公司 / 免费量房','先看工地确认不是只讲低价，再到公司当面把验收节点、付款方式和保障规则讲清楚。','付款节点说明 / 验收流程图'],
        ['工艺型','工艺 / 落地','便宜会不会质量差','看工地 / 到公司 / 免费量房','先现场看施工和完工，再到公司确认规则，最后量房算清方案和预算。','真实工地实拍 / 工艺节点图'],
        ['小白型','小白 / 设计','不知道从哪里开始','看工地 / 到公司 / 免费量房','先看工地建立判断标准，再到公司理清流程，最后免费量房把户型、方案和预算理清楚。','免费量房流程 / 装修步骤说明']
      ]
    }
  };
  const refusal = {
